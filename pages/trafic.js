	...
	return (
		<div className="flex justify-center shadow-sm bg-slate-700 " role="group">
			<div className="bg-slate-700 my-2 rounded-xl">
				<button
					type="button"
					className="inline-flex mx-2 w-36 hover:scale-105 items-center py-2 px-4 text-sm font-medium text-gray-900 bg-transparent rounded-l-lg border border-gray-900 hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700"
				>
					<svg
						aria-hidden="true"
